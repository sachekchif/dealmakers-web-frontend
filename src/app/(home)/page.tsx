    ...
    <section className="">
      <div className="w-full max-w-7xl mx-auto px-4  py-8">
        ...
        <div className="flex items-center justify-center my-2 gap-6">
          ...
          <a className="btn btn-primary btn-outline shadow-md rounded-md justify-end">
            Learn More
          </a>
        </div>
      </div>
    ...
    <article className="my-4">
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="lg:py-24">
          ...
          <div>
            <a className="btn btn-primary shadow-md rounded-md justify-end text-white md:btn-lg">
              Get Started
            </a>
          </div>
        </div>
      ...
      <div className="w-full max-w-7xl mx-auto px-4  py-8">
        <article className="my-2">
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-16">
            <div
              className={clsx(
                "relative h-64 overflow-hidden sm:h-80  lg:h-full lg:order-last"
              )}
            >
              <Image
                alt="Mountains"
