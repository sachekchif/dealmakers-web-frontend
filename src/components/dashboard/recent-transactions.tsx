  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        <CardTitle className="text-lg font-medium">Recent Transaction</CardTitle>
          ...
          <TableBody>
            {transactions.map((transaction) => (
              <TableRow key={transaction.id}>
                ...
                <TableCell>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">{transaction.user.bank}</div>
                    </div>
                  </div>
                </TableCell>
                ...
                <TableCell>
                  <Badge
                    variant={transaction.type === "Withdrawal" ? "destructive" : "default"}
                    className={
